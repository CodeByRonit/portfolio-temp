...
const Contact = ({setLoading}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await fetch('https://formspree.io/f/mzbndjrk', {
            method: 'POST',
            body: formData,
            headers: {
            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form id='contact-me' onSubmit={handleSubmit}>
                        <input type="text" id="fname" name="Name" placeholder="Your Full Name" required></input>
                        <input type="mail" id="mailid" name="Email" placeholder="Your Email Address" required></input>
                        <input type="text" id="sub" name="Subject" placeholder="Your Email Subject" required></input>
                        <textarea id="msg" name="Message" placeholder="Your Email Content" required></textarea>
